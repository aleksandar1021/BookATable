        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivationCode = table.Column<string>(type: "nvarchar(10)", nullable: false),
                    IsActivatedUser = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Place = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: true),
                    AddressOfPlace = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkFromHour = table.Column<byte>(type: "tinyint", nullable: false),
                    WorkUntilHour = table.Column<byte>(type: "tinyint", nullable: false),
                    WorkFromMinute = table.Column<byte>(type: "tinyint", nullable: false),
                    WorkUntilMinute = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AppendiceRestaurants",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppendiceId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppendiceRestaurants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppendiceRestaurants_Appendices_AppendiceId",
                        column: x => x.AppendiceId,
                        principalTable: "Appendices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppendiceRestaurants_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealCategoryRestaurants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MealCategoryRestaurants_MealCategories_MealCategoryId",
                        column: x => x.MealCategoryId,
                        principalTable: "MealCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MealCategoryRestaurants_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeHour = table.Column<byte>(type: "tinyint", nullable: false),
                    TimeMinute = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationAppendices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationAppendices_Appendices_AppendiceId",
                        column: x => x.AppendiceId,
                        principalTable: "Appendices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationAppendices_Reservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppendiceRestaurants_AppendiceId",
                table: "AppendiceRestaurants",
                column: "AppendiceId");

            migrationBuilder.CreateIndex(
                name: "IX_AppendiceRestaurants_RestaurantId",
                table: "AppendiceRestaurants",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_Appendices_Name",
                table: "Appendices",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealCategoryRestaurants_RestaurantId",
                table: "MealCategoryRestaurants",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationAppendices_AppendiceId",
                table: "ReservationAppendices",
                column: "AppendiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationAppendices_ReservationId",
                table: "ReservationAppendices",
